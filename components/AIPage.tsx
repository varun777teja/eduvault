  ...
  return (
    <div className="h-full bg-slate-50 flex flex-col overflow-hidden items-center justify-center p-8">
      <div className="text-center animate-in fade-in zoom-in duration-1000">
        <div className="w-24 h-24 bg-white border border-slate-200 rounded-[3rem] flex items-center justify-center mx-auto mb-8 shadow-xl overflow-hidden p-5">
          <img src="https://i.ibb.co/6JbSBhjt/logobrahma.png" alt="Brahma AI" className="w-full h-full object-contain opacity-40" />
        </div>
